...
while cadastrar.upper() == 'S':
    ...
    # #calcula numero alunos aprovados e reprovados
...
if sexo=='M' and reprovados:

    print('Total de pessoas do sexo masculino reprovadas'+ str(reprovados))

if sexo=='F' and reprovados:

    print('Total de pessoas do sexo feminino reprovadas'+ str(reprovados))


#VALORES ABSOLUTOS
# print('Total de pessoas do sexo feminino aprovadas' +str(feminino))
# print('Total de pessoas do sexo masculino aprovadas' +str(masculino))
# print('Total de pessoas do sexo feminino de exame' +str(femininoF))
# print('Total de pessoas do sexo masculino de exame' +str(masculinoE))
# print('Total de pessoas do sexo feminino reprovadas')
# print('Total de pessoas do sexo masculino reprovadas')